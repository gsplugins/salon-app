...
function Body({ token }: { token: string }) {
  ...
  if (!data) {
    return <p className="text-sm text-zinc-800">Could not load analytics.</p>;
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-xl font-semibold text-zinc-800 dark:text-white">Reports</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900/50">
          <p className="text-sm text-zinc-800">Bookings</p>
          <p className="mt-2 text-3xl font-semibold">{data.total_bookings}</p>
        </div>
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900/50">
          <p className="text-sm text-zinc-800">Revenue (completed)</p>
      ...
      <section className="rounded-2xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900/50">
        <h2 className="text-sm font-semibold text-zinc-800 dark:text-white">Top services</h2>
