      ...
      <header className="border-b border-zinc-200/80 bg-zinc-50/95 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/95">
        <div className="mx-auto flex max-w-4xl flex-wrap items-center justify-between gap-3 px-4 py-3 sm:px-6">
          ...
          <nav className="flex flex-wrap items-center gap-2 text-sm font-medium">
            ...
            <Link href="/app" className="rounded-lg px-2 py-1 text-zinc-800 hover:bg-zinc-100 hover:text-rose-800 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-rose-200">
              Account
            </Link>
